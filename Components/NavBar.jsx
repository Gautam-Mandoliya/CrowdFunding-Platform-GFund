    ...
    lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="relative flex items-center justify-between">
        <div className="flex items-center">
          <a href="/"
              ...
              className="inline-flex items-center mr-8">
                ...
                <span className="ml-2 text-xl font-bold tracking-wide text-gray-100 uppercase">G-Fund</span>
              </a>
              <ul className="flex items-cnter hidden space-x-8 lg:flex">
                {menuList.map((el,i)=>(
                  <li key={i+1}>
                    <a href="/"
        ...
        <div className="lg:hidden z-40">
          ...
          title="Open Menu"
          className="p-2 -mr-1 transition duration-200 
          ...
          >
            ...
            {isMenuOpen && (
              <div className="absolute top-0 left -0 w-full">
                <div className="pg-5 bg-white border rounded shadow-sm">
                   <div className="flex items-center justify-between mb-4">
                     <div>
                      ...
                      text-gray-800 uppercase">Company</span>
                       </a>
                      </div>
                      <div>
                        <button
                          ...
                          0,1.4C4.5,19.9,4.7,20,5,20s0.5-0.1,0.7-0.316.3-6.316.3,6.3c0.2,0.2,0.5,0.3,0.7,0.350.5-0.1,0.7-0.3 c0.4-0.4,0.4-1, 
                          0-1.4L13.4,1216.3-6.3C20.1,5.3,20.1,4.7,19.7,4.3z"/>
                          </svg>
                        </button>
                      </div>
                    </div>
