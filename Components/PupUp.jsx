          ...
          {/*content*/}
            ...
            {/*body*/}
                <div className="relative p-6 flex-auto">
                  <p className="my-6 text-slate-800 text-lg leading-relaxed">
                  {donate.description}
                  </p>
                  <input
                  ...
                  />
                    ...
                    <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                      ...
                      <button
                      className="background text-white active: bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow 
